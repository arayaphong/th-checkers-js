...
> หมายเหตุ: กติกาในเอกสารนี้สะท้อน "พฤติกรรมจริงของเอนจิน" ไม่ใช่กติกาสากลทั่วไป
> จุดที่หมากฮอสไทยต่างจากหมากฮอสสากล จะมีระบุไว้ในแต่ละหัวข้อ
...
![ตำแหน่งเริ่มต้น](docs/images/board-setup.svg)
...
![การเดินของเบี้ย](docs/images/move-pion.svg)
...
![การเดินของฮอส](docs/images/move-dame.svg)
...
2. **ไม่บังคับให้กินมากที่สุด** — ถ้ามีหลายทางให้กิน เลือกทางไหนก็ได้ ไม่จำเป็นต้องเลือกทางที่กินได้จำนวนมากที่สุด
   *(ต่างจากหมากฮอสสากลที่บังคับกินให้ได้มากที่สุด)*
...
![การกินของเบี้ย](docs/images/capture-pion.svg)
...
- **ลงไกลกว่านั้นไม่ได้** — เป็นกฎแบบหมากฮอสไทย ("short king") ต่างจากฮอสสากลที่เลือกลงช่องไหนก็ได้หลังตัวที่กิน
- ถ้ามีหมาก 2 ตัวติดกัน หรือเจอหมากฝ่ายเดียวกันขวาง จะกินทิศนั้นไม่ได้

![การกินของฮอส](docs/images/capture-dame.svg)
...
![การกินต่อเนื่องของฮอส](docs/images/multi-capture-dame.svg)
...
![การเลื่อนขั้น](docs/images/promotion.svg)
...
| ทิศการกิน | ทแยงไปหน้าเท่านั้น | ทแยงทุกทิศ |
...
> การแสดงผลบนเทอร์มินัล (`app/`) ใช้สัญลักษณ์: `●`/`■` = ฝ่ายขาว, `○`/`□` = ฝ่ายดำ
...
npm run demo     # รันเดโมบนเทอร์มินัล (node app/main.js)
```

โครงสร้างโค้ดหลักอยู่ใน [`core/`](core/) (เอนจินที่ไม่ผูกกับ UI) และ [`app/`](app/) (การแสดงผล/REPL)
